...
(async () => {
	...
	const accountFeed = JSON.parse(fs.readFileSync('./auth/account-feed.json').toString('utf8'))

	for(const transaction of accountFeed.filter(el => el.__typename !== 'WelcomeEvent')){
