...
Transactions.belongsTo(Contas, { constraint: true, foreignKey: 'id_conta', as: 'conta' });
Contas.hasMany(Transactions, { foreignKey: 'id_conta' });

Transactions.belongsTo(Categorias, { constraint: true, foreignKey: 'id_categoria', as: 'categoria' });
Categorias.hasMany(Transactions, { foreignKey: 'id_categoria' });

Transactions.belongsTo(Users, { constraint: true, foreignKey: 'id_users', as: 'users' });
